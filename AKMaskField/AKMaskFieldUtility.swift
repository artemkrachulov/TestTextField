...
open class AKMaskFieldUtility {
    ...
    open class func rangeFromString(_ string: String, nsRange: NSRange) -> Range<String.Index>! {
    ...
    open class func substring(_ sourceString: String?, withNSRange range: NSRange) -> String {
    ...
    open class func replace(_ sourceString: inout String!, withString string: String, inRange range: NSRange) {
        sourceString = sourceString.replacingCharacters(in: rangeFromString(sourceString, nsRange: range), with: string)
    }
    
    open class func replacingOccurrencesOfString(_ string: inout String!, target: String, withString replacement: String) {
        string = string.replacingOccurrences(of: target, with: replacement, options: .regularExpression, range: nil)
    }
    
    open class func maskField(_ maskField: UITextField, moveCaretToPosition position: Int) {
    ...
    open class func matchesInString(_ string: String, pattern: String) -> [NSTextCheckingResult] {
        return  try!
    ...
    open class func findIntersection(_ ranges: [NSRange], withRange range: NSRange) -> [NSRange?] {
